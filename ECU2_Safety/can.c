/*
 * ---------------------------------------------------------------------------
 *  ECU-2 CAN2 driver : controller initialisation and frame transmission
 *  CAN2 : RD2 = P0.23 (PINSEL1[15:14] = 01), TD2 = P0.24 (PINSEL1[17:16] = 01)
 *  Bit rate : 500 kbps  (PCLK = 15 MHz)
 * ---------------------------------------------------------------------------
 */
#include "ecu2.h"
